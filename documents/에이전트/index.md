...
!!! info "1차 설명과 최종 구현"
    ...
    최종 프로젝트는 **등록 JOB 14종·공격형/안전형 두 성향·PostgreSQL 39테이블·WatchRunner**로
    확장됐다. 현재 상태와 최종 역할은 [최종 프로젝트 한눈에](../facts/최종프로젝트.md),
    최종 구현의 구성요소별 설명은 [핵심 기능 (최종)](../핵심기능/index.md),
    코드 수준 기록은 [엔지니어링 부록](../final/quantinue-engineering.html)을 따른다.
