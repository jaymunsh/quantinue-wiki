...
> 2026-07-06 · **1차 baseline 병입 후** 남은 안건만. 위에서부터 결정 → 병입 지시 시 제거.
> ✅ 병입 완료(결정 #2~#7): 투자유형·11단계·macro_veto폐지·Alpaca·risk_score 0~100·타이밍 → `결정 로그` 참조.
...
### 💡 성혁(schema keeper·Reviewer) 관점

내 파트는 **리셋 — 미착수**. 이전 초안 무시하고 `tb_review`(파이프라인 baseline)에서 새로 설계 시작. 회의 전에 **B8을 한 그림으로** 정리해 가면 빠르다:
